...
class RequestProxy:
    ...
    def __init__(self, web_proxy_list=["http://10.24.95.119:19889"]):
    ...
    def generate_proxied_request(self, test_url, params={}, req_timeout=30):
    ...
    def get_valid_proxy(self):
        ...
        while 1:
            req = self.generate_proxied_request(turl)
            if req is None:
                continue
            if req.status_code == 200:
                break
        return self.worker_proxy
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        print(req_proxy.get_valid_proxy())
